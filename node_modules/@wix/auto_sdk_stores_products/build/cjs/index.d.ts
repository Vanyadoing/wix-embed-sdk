...
import { P as Product, C as CreateProductResponse, U as UpdateProduct, a as UpdateProductResponse, V as VariantOverride, b as UpdateVariantsResponse, M as MediaDataForWrite, c as MediaAssignmentToChoice, d as Collection, e as CreateCollectionResponse, f as UpdateCollection, g as UpdateCollectionResponse, S as SetValue, B as BulkUpdateProductsResponse, A as AdjustValue, h as BulkAdjustProductPropertiesResponse, i as ProductsQueryBuilder, G as GetProductOptions, j as GetProductResponse, k as GetCollectionBySlugResponse, l as ProductOptionsAvailabilityResponse, Q as QueryProductVariantsOptions, m as QueryProductVariantsResponse, n as PlatformQuery, o as QueryStoreVariantsResponse, p as GetStoreVariantResponse, q as ProductCollectionChangedEnvelope, r as ProductCollectionCreatedEnvelope, s as ProductCollectionDeletedEnvelope, t as ProductChangedEnvelope, u as ProductCreatedEnvelope, v as ProductDeletedEnvelope, w as ProductVariantsChangedEnvelope } from './stores-catalog-v1-product-products.universal-Css_EY8d.js';
export { aG as AddProductMediaRequest, aJ as AddProductMediaResponse, aM as AddProductMediaToChoicesRequest, aN as AddProductMediaToChoicesResponse, aC as AddProductsToCollectionRequest, aD as AddProductsToCollectionResponse, X as AdditionalInfoSection, bg as AdjustValueValueOneOf, ch as AggregateProductsRequest, ci as AggregateProductsResponse, be as AllowedProductsCountLimitExceededErrorData, ba as ApplicationError, cm as BaseEventMetadata, bb as BulkActionMetadata, bk as BulkAdjustProductPropertiesByFilterSyncRequest, bl as BulkAdjustProductPropertiesByFilterSyncResponse, bf as BulkAdjustProductPropertiesRequest, ax as BulkDeleteProductsRequest, ay as BulkDeleteProductsResponse, b8 as BulkProductResult, ce as BulkQueryCustomFieldsRequest, cf as BulkQueryCustomFieldsResponse, a_ as BulkRemoveCustomFieldsRequest, a$ as BulkRemoveCustomFieldsResponse, aY as BulkSetCustomFieldsRequest, aZ as BulkSetCustomFieldsResponse, bc as BulkUpdateProductsByFilterSyncRequest, bd as BulkUpdateProductsByFilterSyncResponse, b6 as BulkUpdateProductsRequest, a4 as Choice, bs as CollectionChanged, br as CollectionCreated, bt as CollectionDeleted, R as CostAndProfitData, b0 as CreateCollectionRequest, ao as CreateDigitalProductRequest, ap as CreateDigitalProductResponse, am as CreateProductPlatformizedRequest, an as CreateProductPlatformizedResponse, al as CreateProductRequest, bF as CursorPaging, bI as Cursors, cg as CustomFieldsContainer, a2 as CustomTextField, b2 as DeleteCollectionRequest, b3 as DeleteCollectionResponse, aQ as DeleteProductOptionsRequest, aR as DeleteProductOptionsResponse, av as DeleteProductPlatformizedRequest, aw as DeleteProductPlatformizedResponse, at as DeleteProductRequest, au as DeleteProductResponse, a6 as Discount, D as DiscountType, F as FileType, c3 as FocalPoint, L as FormattedPrice, bX as GetCollectionBySlugRequest, bV as GetCollectionRequest, bW as GetCollectionResponse, bP as GetProductPlatformizedRequest, bQ as GetProductPlatformizedResponse, bO as GetProductRequest, bM as GetProductsRequest, bN as GetProductsResponse, cb as GetStoreVariantRequest, ck as IdentificationData, cl as IdentificationDataIdOneOf, I as InventoryStatus, b9 as ItemMetadata, ab as Keyword, y as MeasurementUnit, Z as Media, aH as MediaDataForWriteMediaSourceOneOf, _ as MediaItem, $ as MediaItemItemOneOf, z as MediaItemType, a0 as MediaItemUrlAndSize, a1 as MediaItemVideo, cj as MessageEnvelope, N as NumericPropertyRange, aI as OptionAndChoice, O as OptionType, a5 as PageUrl, by as Paging, bA as PagingMetadata, bL as PagingWithBigLimit, bj as PercentageData, c1 as PlatformMedia, c2 as PlatformMediaMediaOneOf, bE as PlatformPaging, bH as PlatformPagingMetadata, bC as PlatformQueryPagingMethodOneOf, c5 as PreorderInfo, K as PriceData, T as PricePerUnitData, bp as ProductChanged, bo as ProductCreated, bq as ProductDeleted, a3 as ProductOption, bY as ProductOptionsAvailabilityRequest, x as ProductType, cn as ProductsQueryResult, bh as PropertyAdjustmentData, bi as PropertyAdjustmentDataByOneOf, bx as Query, bT as QueryCollectionsPlatformizedRequest, bU as QueryCollectionsPlatformizedResponse, bR as QueryCollectionsRequest, bS as QueryCollectionsResponse, cc as QueryCustomFieldsRequest, cd as QueryCustomFieldsResponse, b_ as QueryProductVariantsRequest, bB as QueryProductsPlatformizedRequest, bG as QueryProductsPlatformizedResponse, bw as QueryProductsRequest, bz as QueryProductsResponse, bJ as QueryProductsWithBigPageLimitRequest, b$ as QueryStoreVariantsRequest, c6 as QueryStoreVariantsWithBigLimitRequest, bK as QueryWithBigPageLimit, bm as ReCloneStoreRequest, bn as ReCloneStoreResponse, aU as RemoveCustomFieldsRequest, aV as RemoveCustomFieldsResponse, aW as RemoveProductBrandRequest, aX as RemoveProductBrandResponse, aO as RemoveProductMediaFromChoicesRequest, aP as RemoveProductMediaFromChoicesResponse, aK as RemoveProductMediaRequest, aL as RemoveProductMediaResponse, b4 as RemoveProductRibbonRequest, b5 as RemoveProductRibbonResponse, aE as RemoveProductsFromCollectionRequest, aF as RemoveProductsFromCollectionResponse, aA as ResetAllVariantDataRequest, aB as ResetAllVariantDataResponse, Y as Ribbon, ae as SecuredMedia, aa as SeoSchema, aS as SetCustomFieldsRequest, aT as SetCustomFieldsResponse, b7 as SetValueValueOneOf, ad as Settings, H as SortOrder, bD as Sorting, J as Stock, c0 as StoreVariant, ac as Tag, ca as UnlimitedPlatformCursorPaging, c9 as UnlimitedPlatformPaging, c7 as UnlimitedPlatformQuery, c8 as UnlimitedPlatformQueryPagingMethodOneOf, b1 as UpdateCollectionRequest, ar as UpdateProductPlatformizedRequest, as as UpdateProductPlatformizedResponse, aq as UpdateProductRequest, az as UpdateVariantsRequest, af as V1CreateProductPlatformizedRequest, ag as V1CreateProductPlatformizedResponse, aj as V1DeleteProductPlatformizedRequest, ak as V1DeleteProductPlatformizedResponse, ah as V1UpdateProductPlatformizedRequest, ai as V1UpdateProductPlatformizedResponse, a7 as Variant, bv as VariantChanged, bZ as VariantData, a8 as VariantDataWithNoStock, a9 as VariantStock, bu as VariantsChanged, E as Version, c4 as VideoResolution, W as WebhookIdentityType } from './stores-catalog-v1-product-products.universal-Css_EY8d.js';
...
interface UpdateCollectionSignature {
     ...
     */
    (_id: string, collection: UpdateCollection): Promise<UpdateCollectionResponse>;
}
...
interface BulkAdjustProductPropertySignature {
     ...
     * @param - Product IDs.
     */
    (adjust: AdjustValue, ids: string[]): Promise<BulkAdjustProductPropertiesResponse>;
}
...
interface GetProductSignature {
     ...
     */
    (_id: string, options?: GetProductOptions | undefined): Promise<GetProductResponse>;
}
...
interface GetProductOptionsAvailabilitySignature {
     ...
     */
    (_id: string, options: Record<string, string>): Promise<ProductOptionsAvailabilityResponse>;
}
...
interface QueryProductVariantsSignature {
     ...
     * @param - Requested product ID.
     */
    (_id: string, options?: QueryProductVariantsOptions | undefined): Promise<QueryProductVariantsResponse>;
}
