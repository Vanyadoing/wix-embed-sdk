...
__export(meta_exports, {
  getStoresLocation: () => getStoresLocation2,
  queryStoresLocations: () => queryStoresLocations2
});
...
// src/stores-catalog-v3-stores-location-stores-locations-v-3.meta.ts
function getStoresLocation2() {
  const payload = { storesLocationId: ":storesLocationId" };
  const getRequestOptions = getStoresLocation(payload);
...
function queryStoresLocations2() {
  const payload = {};
  const getRequestOptions = queryStoresLocations(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
