...
declare function createInfoSection(): __PublicMethodMetaInfo<'POST', {}, CreateInfoSectionRequest$1, CreateInfoSectionRequest, CreateInfoSectionResponse$1, CreateInfoSectionResponse>;
declare function getInfoSection(): __PublicMethodMetaInfo<'GET', {
    infoSectionId: string;
}, GetInfoSectionRequest$1, GetInfoSectionRequest, GetInfoSectionResponse$1, GetInfoSectionResponse>;
declare function getOrCreateInfoSection(): __PublicMethodMetaInfo<'POST', {}, GetOrCreateInfoSectionRequest$1, GetOrCreateInfoSectionRequest, GetOrCreateInfoSectionResponse$1, GetOrCreateInfoSectionResponse>;
declare function bulkGetOrCreateInfoSections(): __PublicMethodMetaInfo<'POST', {}, BulkGetOrCreateInfoSectionsRequest$1, BulkGetOrCreateInfoSectionsRequest, BulkGetOrCreateInfoSectionsResponse$1, BulkGetOrCreateInfoSectionsResponse>;
declare function updateInfoSection(): __PublicMethodMetaInfo<'PATCH', {
    infoSectionId: string;
}, UpdateInfoSectionRequest$1, UpdateInfoSectionRequest, UpdateInfoSectionResponse$1, UpdateInfoSectionResponse>;
declare function deleteInfoSection(): __PublicMethodMetaInfo<'DELETE', {
    infoSectionId: string;
}, DeleteInfoSectionRequest$1, DeleteInfoSectionRequest, DeleteInfoSectionResponse$1, DeleteInfoSectionResponse>;
declare function queryInfoSections(): __PublicMethodMetaInfo<'POST', {}, QueryInfoSectionsRequest$1, QueryInfoSectionsRequest, QueryInfoSectionsResponse$1, QueryInfoSectionsResponse>;
declare function bulkCreateInfoSections(): __PublicMethodMetaInfo<'POST', {}, BulkCreateInfoSectionsRequest$1, BulkCreateInfoSectionsRequest, BulkCreateInfoSectionsResponse$1, BulkCreateInfoSectionsResponse>;
